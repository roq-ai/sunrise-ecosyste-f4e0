...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['members', 'trainer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Plan', path: '/plans', entity: 'plan', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Trainer', path: '/trainers', entity: 'trainer', service: AccessServiceEnum.PROJECT, icon: FiBox },
